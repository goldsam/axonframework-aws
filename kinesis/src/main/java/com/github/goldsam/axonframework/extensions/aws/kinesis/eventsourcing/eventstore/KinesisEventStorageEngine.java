...
import com.github.goldsam.axonframework.extensions.aws.kinesis.eventsourcing.eventstore.recordpercommit.RecordPerCommitStorageStrategy;
...
public class KinesisEventStorageEngine extends BatchingEventStorageEngine {
     ...
     */
    protected KinesisEventStorageEngine(Builder builder) {
        super(builder);
        this.storageStrategy = builder.storageStrategy;
        this.kinesisClient = builder.kinesisClient;
        ensureIndexes();
    }

    /**
     * Instantiate a Builder to be able to create a {@link KinesisEventStorageEngine}.
     * <p>
    ...
    /**
     * Builder class to instantiate a {@link KinesisEventStorageEngine}.
     * <p>
     * The following configurable fields have defaults:
     * <ul>
     * <li>The snapshot {@link Serializer} defaults to {@link org.axonframework.serialization.xml.XStreamSerializer}.</li>
    ...
    public static class Builder extends BatchingEventStorageEngine.Builder {
         ...
         */
        public KinesisEventStorageEngine build() {
            return new KinesisEventStorageEngine(this);
        }
