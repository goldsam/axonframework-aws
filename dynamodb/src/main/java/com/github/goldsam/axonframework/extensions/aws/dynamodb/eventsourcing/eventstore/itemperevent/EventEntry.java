...
import com.github.goldsam.axonframework.extensions.aws.dynamodb.eventhandling.EventMessageReader;
import com.github.goldsam.axonframework.extensions.aws.dynamodb.eventhandling.EventMessageWriter;
...
public class EventEntry implements DomainEventData<Object> {
     ...
     *
     * @param item DynamoDB item that contains data to represent an EventEntry
     * @param configuration Configuration containing the property names
     */
    public EventEntry(Item item, EventEntryConfiguration configuration) {
    ...
    public EventEntry(byte[] eventData, EventEntryConfiguration configuration, Serializer serializer) {
     ...
     */
    public Item asItem(EventEntryConfiguration configuration) {
        return new Item()
