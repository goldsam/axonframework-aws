...
package com.github.goldsam.axonframework.extensions.aws.dynamodb.eventsourcing.eventstore.itemperevent;
...
public class EventEntryConfiguration {
    ...
    private final String timestampProperty, eventIdentifierProperty, aggregateIdentifierProperty,
            sequenceNumberProperty, typeProperty, payloadTypeProperty, payloadRevisionProperty, 
            payloadProperty, metaDataProperty;
    ...
    /**
     * Get the name of the property representing the identifier of the event.
     *
     * @return the name of the property representing the event identifier
     */
    ...
    /**
     * Get the name of the property representing the aggregate identifier of the event.
     *
     * @return the name of the property representing the aggregate identifier
     */
    ...
    /**
     * Get the name of the property representing the aggregate sequence number of the event.
     *
     * @return the name of the property representing the aggregate sequence number
     */
    ...
    /**
     * Get the name of the property representing the aggregate type.
     *
     * @return the name of the property representing the aggregate type
     */
    ...
    /**
     * Get the name of the property representing the payload type.
     *
     * @return the name of the property representing the payload type
     */
    ...
    /**
     * Get the name of the property representing the payload revision.
     *
     * @return the name of the property representing the payload revision
     */
    ...
    /**
     * Get the name of the property representing the payload data.
     *
     * @return the name of the property representing the payload data
     */
    ...
    /**
     * Get the name of the property representing the metadata.
     *
     * @return the name of the property representing the metadata
     */
