...
import com.github.goldsam.axonframework.extensions.aws.dynamodb.eventsourcing.eventstore.AbstractDynamoDBEventStorageStrategy;
import com.github.goldsam.axonframework.extensions.aws.dynamodb.eventsourcing.eventstore.DynamoDBEventStorageConfiguration;
 ...
 */
public class RecordPerEventStorageStrategy extends AbstractDynamoDBEventStorageStrategy {

    /**
     * Initializes a {@link PutRequestPerCommitStorageStrategy} with default configuration.
     */
    public RecordPerEventStorageStrategy() {
        super(DynamoDBEventStorageConfiguration.getDefault());
    }
     ...
     */
    public RecordPerEventStorageStrategy(DynamoDBEventStorageConfiguration storageConfiguration) {
